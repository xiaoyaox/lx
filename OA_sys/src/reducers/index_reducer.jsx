...
import {SET_STATE, REQUEST_POSTS, RECEIVE_POSTS} from '../actions/index_action'
import {RECORD_STATE, SAVE_PRODUCT_LIST, NEW_PRODUCT_DATA} from '../actions/index_action'
import {DELETE_ITEM} from '../actions/index_action'
import {GET_DATA_START , GET_DATA_SUCCESS, TEST_DISPATCH} from '../actions/index_action'
