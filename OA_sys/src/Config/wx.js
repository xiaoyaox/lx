! function(a, b) {
	...
	let o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H;
	if (!a.jWeixin) return o = {
		...
		let a = s.match(/micromessenger\/(\d+\.\d+\.\d+)/) || s.match(/micromessenger\/(\d+\.\d+)/);
		return a ? a[1] : ""
	}(), A = !1, B = !1, C = {
		initStartTime: l(),
		initEndTime: 0,
