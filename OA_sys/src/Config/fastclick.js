...
(function() {
	...
	function FastClick(layer, options) {
		...
		let methods = ['onMouse', 'onClick', 'onTouchStart', 'onTouchMove', 'onTouchEnd', 'onTouchCancel'];
		let context = this;
		...
		if (!Event.prototype.stopImmediatePropagation) {
			layer.removeEventListener = function(type, callback, capture) {
				let rmv = Node.prototype.removeEventListener;
				if (type === 'click') {
			...
			layer.addEventListener = function(type, callback, capture) {
				let adv = Node.prototype.addEventListener;
				if (type === 'click') {
