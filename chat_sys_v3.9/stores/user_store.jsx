...
class UserStoreClass extends EventEmitter {
    ...
    setPermissionData(permissionStr) {
      permissionStr = permissionStr ? permissionStr.replace(/"/g,"") : "";
      var permiData = permissionStr.split(',');
      var obj = {};
      for(var i = 0;i < permiData.length; i++){
        var temp = permiData[i];
        var tempArr = temp.split('/');
        if(obj[tempArr[1]]) {
          obj[tempArr[1]].push(tempArr[2]);
        } else {
          obj[tempArr[1]] = [tempArr[2]];
        }
      }
