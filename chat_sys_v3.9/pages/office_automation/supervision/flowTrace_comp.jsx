...
//签报管理的办文跟踪组件。
class SuperviseFlowTraceComp extends React.Component {
  constructor(props) {
      super(props);
      this.state = {
      };
...
SuperviseFlowTraceComp.defaultProps = {
};

SuperviseFlowTraceComp.propTypes = {
  backDetailCall:React.PropTypes.func,
};

export default SuperviseFlowTraceComp;
