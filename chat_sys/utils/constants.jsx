...
export const BlacklistTypes = keyMirror({
  RECEIVED_BLACKLIST: null,
  RECEIVED_NOT_IN_BLACKLIST: null,
  RECEIVED_BLACKLIST_ADD_USER: null,
  RECEIVED_BLACKLIST_DELETE_USER: null
})
