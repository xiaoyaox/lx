                ...
                <table className='channel-header alt'>
                    <tbody>
                        <tr>
                            ...
                            <th>
                              <button type="button" className="btn btn-primary comment-btn pull-left search-btns m-r-5" onClick={() => GlobalActions.redirectToModulesPage()}>返回</button>
                            </th>
                            <th>
                              <button type="button" className="btn btn-primary comment-btn pull-left search-btns" onClick={() => GlobalActions.emitUserLoggedOutEvent('/login')}>退出</button>
                            </th>
                        </tr>
                    </tbody>
                </table>
