...
export default class FileAttachment extends React.Component {
    ...
    loadFiles() {
        ...
        if (fileType === 'image') {
            ...
            const thumbnailUrl = FileStore.getFileThumbnailPath(fileInfo.thumbnail_path);
    ...
    render() {
        ...
        const fileUrl = FileStore.getFilePath(fileInfo.path);
                ...
                thumbnail = (
                    <div
                        ...
                        style={{
                            ...
                            backgroundImage: `url(${FileStore.getFileThumbnailPath(fileInfo.thumbnail_path)})`
                        }}
                    />
                );
            } else {
