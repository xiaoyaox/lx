...
export default class LoginController extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ldapEnabled: global.window.mm_license && global.window.mm_license.IsLicensed === 'true' && global.window.mm_config.EnableLdap === 'true',
            ...
            samlEnabled: global.window.mm_license && global.window.mm_license.IsLicensed === 'true' && global.window.mm_config.EnableSaml === 'true',
            loginId,
            password: '',
            showMfa: false,
            loading: false
            ...
            (err) => {
              console.log("登录报错的错误信息--：",err);
                if (err.id === 'api.user.login.not_verified.app_error') {
                    ...
                    this.setState({showMfa: false, serverError: message, loading: false});
                }
            }
        );
    }
